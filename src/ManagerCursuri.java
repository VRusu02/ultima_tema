...
public class ManagerCursuri {
	...
	public String[] CursuriProf(Profesor prof)
	{
		String[] list = new String[cursuri.size()];
		int nr = 0;
	...
	public String[] cautaStud(Curs curs, Student student) {
		String[] list = new String[cursuri.size()];
		int nr = 0;
		for (Curs c : cursuri)
			if (c.equals(curs)) {
				if (c.cautaStud(student)) {
					list[nr++] = c.nume;
				}
			}
		return list;
	...
	public void setCursuri(ArrayList <Curs> curs){
		this.cursuri=curs;
	}
