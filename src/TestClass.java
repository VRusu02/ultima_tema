...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		ArrayList<Student> listStud = new ArrayList<>(Arrays.asList(dataManager.createStudentsData()));
		ArrayList<Profesor> listProf = new ArrayList<>(Arrays.asList(dataManager.createProfesorData()));
		JFrame frame = new JFrame("Graphic user interface");

		LoginForm loginForm = new LoginForm(frame, listProf, listStud);
